...
**Into the Void** is a private, browser-based web application designed as a digital catharsis tool. It provides a safe space to type out grief, anger, or unspoken words, and physically watch them dissolve into nothingness. 

## 🌌 The Concept
Grief often comes with words we never got to say. This project relies on the physical release of typing those words, without the burden of storing them. 
